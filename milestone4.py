...
class Hangman:
    ...
    def __init__(self, word_list, num_lives=5):
        ...
        print(self.word) # checker
        self.word_guessed = list('_' * len(self.word)) # word guessed by user
        # no. of unique letters left to guess:
        self.num_letters = len(self.word) - len(set(self.word_guessed)) 
    ...
    def check_guess(self, guess):
        ...
        if guess in self.word:
            ...
            print(self.word_guessed) # checker
            self.num_letters -= 1
        else:
            self.num_lives -= 1
...
h = Hangman(['apple', 'banana', 'orange', 'cherry', 'mango'])
h.ask_for_input()
